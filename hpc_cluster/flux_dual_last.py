...
def main():
    ...
    A_aura = A_target_blurred.view(b, seq, c)
    A_fisica = (A_target > 0.1).to(CONFIG["dtype"])
    ...
    pipe = inject_semantic_processors(pipe, A_aura, injection_strength=CONFIG["injection_strength"])
    ...
    with torch.no_grad():
        ...
        latents = latents_lake * (1.0 - A_fisica) + x0_db * torch.sqrt(A_fisica)    
        ...
        for t in pipe.scheduler.timesteps:
            ...
            delta_v = A_fisica * (v0_db - v_ambient)
