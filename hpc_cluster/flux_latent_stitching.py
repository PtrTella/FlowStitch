...
CONFIG = {
    ...
    "lambda_val": 1.0,                              # Moltiplicatore di Lagrange (Forza dell'Iniezione)
    "device": "cuda",
...
def main():
    ...
    pipe = FluxPipeline.frompretrained(CONFIG["model_id"], torch_dtype=CONFIG["dtype"]).to(CONFIG["device"])
